...
describe('P3 S current-main Astolfo s1 consumer replay', () => {
  ...
  it('is exactly the dispatched +1 frozen material delta at 112/944 with no duplicates', () => {
    ...
    expect(overlap).toHaveLength(112);
