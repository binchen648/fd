...
/**
 * Card Zone/source-state policy for source-bound runtime consumers.
 *
 * Canonical basis: FD-Game-Rules-Final 11.1, 11.3 and 11.4. Card Zone owns
 * whether an authoritative card instance is still an active source; consumers
 * such as Lifecycle only ask this policy and do not duplicate the zone rules.
 */
