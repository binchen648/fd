...
| P3-TO-14 | Battle/Resource | Battle-result VP/resource trigger envelope design. | Trigger Gateway accepted; Golden Flow 2 review accepted at `9db8a72` | Unlocks 39 battle-result abilities later. | none first | docs first, later `combat-resolver.ts`, `scoring-resolver.ts` | Gate A design | P3-TO-01 | runtime battle edits | READY_NEXT |
