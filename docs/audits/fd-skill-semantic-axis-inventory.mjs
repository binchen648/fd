...
export function classifyAbility(archive, card, ability) {
  ...
  if (hasPrivateTarget || raw.includes("face_down") || /暗置|隐藏|真名|查看|展示/.test(printed)) visibility.push("HIDDEN_OR_PRIVATE");
