...
| condition | `EVENT_PLAYER_IS_CONTROLLER` | 44 |
...
| condition | `EVENT_PLAYER_LOST_COMBAT` | 15 |
...
| modifier | `effect:combat_power_bonus` | 23 |
...
| battle | `COMBAT_CONDITION` | 76 |
| battle | `COMBAT_EVENT` | 64 |
| battle | `COMBAT_EFFECT` | 27 |
