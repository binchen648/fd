...
| trigger | `combat.resolved` | 41 |
| trigger | `game.started` | 11 |
...
| lifecycle | `duration:while_condition_true` | 1 |
...
| modifier | `rule:card_power:add` | 10 |
...
| modifier | `rule:skill_play_mana_threshold:ignore_below` | 1 |
