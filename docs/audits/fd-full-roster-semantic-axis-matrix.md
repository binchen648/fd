...
| condition | `EVENT_PLAYER_IS_CONTROLLER` | 24 |
...
| lifecycle | `duration:while_source_active` | 11 |
...
| lifecycle | `duration:while_condition_true` | 4 |
...
| modifier | `rule:card_power:add` | 13 |
