...
This contract is the first-read file for Phase 3 agents. It prevents role drift between automation, runtime implementation, and independent acceptance. Read larger Phase 3 documents only when the assigned task explicitly requires them.
...
Do not reread unrelated Phase 3 documents by default.
