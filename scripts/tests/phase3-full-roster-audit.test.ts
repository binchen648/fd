...
describe('Phase 3 independent full-roster automation audit', () => {
  ...
  it('keeps the checked-in real automation audit exact and independently recomputed', () => {
    ...
    expect(report).toContain('sourceEvidenceOverlayCount=90');
    expect(report).toContain('sourceEvidenceOverlayAbilityCount=189');
    expect(report).toContain('sourceGroundedCount=162');
    expect(report).toContain('semanticBlockedCount=782');
