...
describe('Phase 3 independent full-roster automation audit', () => {
  ...
  it('keeps the checked-in real automation audit exact and independently recomputed', () => {
    ...
    expect(report).toContain('sourceEvidenceOverlayCount=833');
    expect(report).toContain('sourceEvidenceOverlayAbilityCount=1066');
    expect(report).toContain('sourceGroundedCount=905');
    expect(report).toContain('semanticBlockedCount=39');
