...
describe('Phase 3 independent full-roster automation audit', () => {
  ...
  it('keeps the checked-in real automation audit exact and independently recomputed', () => {
    ...
    expect(report).toContain('sourceEvidenceOverlayCount=99');
    expect(report).toContain('sourceEvidenceOverlayAbilityCount=206');
    expect(report).toContain('sourceGroundedCount=171');
    expect(report).toContain('semanticBlockedCount=773');
