...
describe('Phase 3 independent full-roster automation audit', () => {
  ...
  it('keeps the checked-in real automation audit exact and independently recomputed', () => {
    ...
    expect(report).toContain('sourceEvidenceOverlayCount=679');
    expect(report).toContain('sourceEvidenceOverlayAbilityCount=912');
    expect(report).toContain('sourceGroundedCount=751');
    expect(report).toContain('semanticBlockedCount=193');
