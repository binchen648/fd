...
describe('Phase 3 independent full-roster automation audit', () => {
  ...
  it('keeps the checked-in real automation audit exact and independently recomputed', () => {
    ...
    expect(report).toContain('sourceEvidenceOverlayCount=241');
    expect(report).toContain('sourceEvidenceOverlayAbilityCount=440');
    expect(report).toContain('sourceGroundedCount=313');
    expect(report).toContain('semanticBlockedCount=631');
