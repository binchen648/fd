...
describe('Phase 3 independent full-roster automation audit', () => {
  ...
  it('keeps the checked-in real automation audit exact and independently recomputed', () => {
    ...
    expect(report).toContain('sourceEvidenceOverlayCount=84');
    expect(report).toContain('sourceEvidenceOverlayAbilityCount=175');
    expect(report).toContain('sourceGroundedCount=156');
    expect(report).toContain('semanticBlockedCount=788');
