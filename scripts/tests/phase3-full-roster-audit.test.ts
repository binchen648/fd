...
describe('Phase 3 independent full-roster automation audit', () => {
  ...
  it('keeps the checked-in real automation audit exact and independently recomputed', () => {
    ...
    expect(report).toContain('sourceEvidenceOverlayCount=711');
    expect(report).toContain('sourceEvidenceOverlayAbilityCount=944');
    expect(report).toContain('sourceGroundedCount=783');
    expect(report).toContain('semanticBlockedCount=161');
