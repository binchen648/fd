...
describe('Phase 3 independent full-roster automation audit', () => {
  ...
  it('keeps the checked-in real automation audit exact and independently recomputed', () => {
    ...
    expect(report).toContain('sourceEvidenceOverlayCount=180');
    expect(report).toContain('sourceEvidenceOverlayAbilityCount=344');
    expect(report).toContain('sourceGroundedCount=252');
    expect(report).toContain('semanticBlockedCount=692');
