...
describe('Phase 3 independent full-roster automation audit', () => {
  ...
  it('keeps the checked-in real automation audit exact and independently recomputed', () => {
    ...
    expect(report).toContain('sourceEvidenceOverlayCount=218');
    expect(report).toContain('sourceEvidenceOverlayAbilityCount=406');
    expect(report).toContain('sourceGroundedCount=290');
    expect(report).toContain('semanticBlockedCount=654');
