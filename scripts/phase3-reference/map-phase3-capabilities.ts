...
const SPECIAL_EFFECTS = new Set([
  'TESLA_LIGHTNING_HAND_RULE',
  'TESLA_LIGHTNING_DESCENT_RULE',
  'TESLA_FORCED_OVERCHARGE_RULE',
  'TEZCAT_JAGUAR_KING_RULE',
  'TEZCAT_WARRIOR_OFFICE_RULE',
  'TEZCAT_FIRST_SUN_RULE',
  'TOMOE_DEMONIC_NATURE_RULE',
  'TOMOE_BLAZING_RAIN_RULE',
  'TRISTAN_LAMENT_RULE',
  'TRISTAN_LOVE_RULE',
  'USHIWAKAMARU_ICICLE_CUTTER_RULE',
  'USHIWAKAMARU_EIGHT_BOAT_LEAP_RULE',
  'VALKYRIE_MAIDEN_DESCENT_RULE',
  'VALKYRIE_SWAN_DRESS_RULE',
  'VLAD_PROTECTOR_RULE',
  'VLAD_KAZIKLI_BEY_RULE',
  'XIANGYU_TACTICAL_BODY_RULE',
  'XIANGYU_OVERLORD_MARTIAL_RULE',
  'XIANGYU_CONQUERING_MIGHT_RULE',
  'SPARTACUS_REBELLION_RULE',
  'SPARTACUS_FREE_SPIRIT_RULE',
  'STHENO_DIVINE_CORE_RULE',
  'SUZUKA_WISDOM_RULE',
  'SUZUKA_TENKI_RAIN_RULE',
  'SUZUKA_THREE_THOUSAND_WORLDS_RULE',
  'TAISUI_CALAMITY_RULE',
  'TAISUI_AWAKEN_RULE',
  'TAMAMO_CASCADE_RULE',
  'TAMAMO_WITCHCRAFT_RULE',
  'TAMAMO_TRANSCENDENCE_RULE',
  'TEACH_GENTLEMAN_LOVE_RULE',
  'TEACH_QUEEN_ANNE_RULE',
  'CHARGE_SELECTED_SKILL_ATTACK',
  ...
  'KIYOHIME_HOT_EMBRACE_RULE',
  'KIYOHIME_TRUTH_QUESTION_RULE',
  'KIYOHIME_TWIN_FLAME_RULE',
  'KOTAROU_CHAOS_BRIGADE_RULE',
  'KOTAROU_SCHEME_RULE',
  'KOYO_MAPLE_HUNT_RULE',
  'KOYO_DINOSAUR_MORPH_RULE',
  'KOYO_NINE_DRAGON_RULE',
  'KRIEMHILD_RHINE_GOLD_RULE',
  'KRIEMHILD_WIDOW_RULE',
  'KRIEMHILD_BALMUNG_TRANSFER_RULE',
  'LADYAVALON_IDEAL_REALM_RULE',
  'LADYAVALON_PRETENDER_RULE',
  ...
  'GARETH_DISGUISE_KNIGHT_RULE',
  'GARETH_WOLF_NEVER_SLEEPS_RULE',
  'GARETH_MANA_OVERLOAD_RULE',
  'GEORGIOS_MARTYR_SOUL_RULE',
  'GEORGIOS_GUARDIAN_RIDER_RULE',
  'DRAGON_DESIGNATION_RULE',
  'GIL_INDEPENDENT_ACTION_RULE',
  'GATE_OF_BABYLON_RULE',
  'SPECIAL_NOBLE_PHANTASM_DEFEAT_RULE',
  'MAGIC_ATTACK_ATTRIBUTE_CONVERSION_RULE',
  'TERRITORY_CONSTRUCTION_SCALING_RULE',
  'PLACED_NOBLE_PHANTASM_FIELD_RULE',
  'FIRST_OPPONENT_NOBLE_PHANTASM_MANA_RULE',
  'CONCEALMENT_ELIMINATION_GROWTH_RULE',
  'HIDDEN_TRUE_NAME_VP_DOUBLE_DEFEAT_RULE',
  'TRACKING_MARK_RULE',
  'HUNDRED_FACES_ILLUSION_RULE',
  'POISON_BODY_RULE',
  'SERENITY_DANCE_RULE',
  'REVELATION_VISIBILITY_VP_RULE',
  'DOMINATION_WHEEL_COMMAND_SPELL_RULE',
  'PRETENDER_IDENTITY_X_RULE',
  'TWELVE_LABORS_RULE',
  'HIJIKATA_CODE_RULE',
  'SKILL_COPY_LIFECYCLE_RULE',
  'MARIA_THE_RIPPER_RULE',
  'DARK_FOG_EVENT_RULE',
  'MOTHER_DESIGNATION_RULE',
  'MANSLAYER_REACTION_RULE',
  'FINISHING_SWORD_MEMORY_RULE',
  'BEAST_FORM_RULE',
  'TSAR_CHOICE_RULE',
  'FORCED_RETURN_DISCARD_POWER_RULE',
  'MANA_THRESHOLD_VP_BURN_RULE',
  'ORACLE_REPEAT_RULE',
  'MIRROR_SHIELD_SACRED_LAND_RULE',
  'ORACLE_CHOICE_RULE',
  'JAGUARMAN_AMBUSH_FOREST_RULE',
  'JAGUARMAN_DEATH_CLAW_RULE',
  'RULER_COMMAND_SPELL_BINDING_RULE',
  'JEANNE_LUCK_BANNER_RULE',
  'JEANNE_SACRIFICIAL_DEFEAT_RULE',
  'ATTACK_COUNT_MASS_DEFEAT_RULE',
  'AVENGER_MOVEMENT_VP_RULE',
  'LUCK_ENTRY_DISCARD_AVENGER_RULE',
  'JEKYLL_HYDE_IDENTITY_RULE',
  'JEKYLL_HYDE_BEAST_RULE',
  'KAGEKIYO_HIDDEN_ATTACK_NOBLE_PHANTASM_RULE',
  'KAGEKIYO_HIDDEN_ATTACK_VENGEANCE_RULE',
  'KARNA_BRAHMA_VP_MANA_POWER_RULE',
  'KARNA_ARMOR_RULE',
  'KARNA_DELAYED_DEFEAT_RULE',
  'KINGGIL_TREASURE_ATTRIBUTE_RULE',
  'KINGGIL_BARRAGE_RULE',
  'AZRAEL_RULE',
  'KINGPROTEA_GROWTH_RULE',
  'KINTOKI_GOLDEN_SPARK_RULE',
  'KINTOKI_GOLDEN_EATER_RULE',
  'ATTACK_COPY_TRANSFORM_RULE',
  'LANCELOT_IDENTITY_REVEAL_RULE',
  'DEFERRED_ATTACK_STAT_POWER_RULE',
  'HIDDEN_ATTACK_ACTIVATION_PHALANX_RULE',
  'LIONKING_LUCK_PROTECTION_RULE',
  'ALTERNATE_VP_COST_MOUNT_RULE',
  'HIDDEN_JIN_STAGING_RULE',
  'MATCHING_ATTRIBUTE_HIDDEN_ATTACK_DEFEAT_RULE',
  'AVENGER_DISCARD_CLOSE_OR_DEFEAT_RULE',
  'DEATH_ENTANGLE_FORCED_MOVE_RULE',
  'REACTIVE_PURSUIT_PLAY_RULE',
  'NO_BATTLE_VP_LOSS_RESIDUAL_EXTENSION_RULE',
  'VP_SOURCE_MULTIPLIER_RULE',
  'NOBLE_WEAPON_POWER_TRANSFORM_RULE',
  'MANDRICARDO_WOODEN_SWORD_INHERITANCE_RULE',
  'MAXWELL_PARADOX_DEFEAT_RULE',
  'MAXWELL_MANA_GAIN_REPLACEMENT_RULE',
  'MECHAELI_ROCKET_PUNCH_RULE',
  'ALTER_EGO_REVERSE_ATTRIBUTE_RULE',
  'MEDB_INTOXICATION_VP_RULE',
  'MEDB_SUBMISSION_DEPLOYMENT_RULE',
  'MEDEA_RULE_BREAKER_RECOVERY_RULE',
  'MEDEA_RULE_BREAKER_COMMAND_SPELL_RULE',
  'MELT_VIRUS_INFECTION_COPY_RULE',
  'MELT_SARASVATI_RULE',
  'MELUSINE_ALBION_REPLACEMENT_RULE',
  'MELUSINE_PERI_DANCER_RULE',
  'MERLIN_PRE_MOVE_PLAY_RULE',
  'MERLIN_ILLUSION_COST_POWER_RULE',
  'MHX_SABER_SLAYER_RULE',
  'MHX_GALAXY_REACTOR_RULE',
  'MHX_MAGIC_RESISTANCE_NOBLE_REWARD_RULE',
  'MORGAN_IDEAL_VICTORY_RULE',
  'MORGAN_BERSERKER_SHIFT_RULE',
  'MORIARTY_AUGMENTATION_RULE',
  'MORIARTY_SETTLEMENT_RULE',
  'MORIARTY_ULTIMATE_CRIME_RULE',
  'NEMO_SEA_ROUTE_RULE',
  'NEMO_SPLIT_THOUGHT_RULE',
  'NEMO_NAUTILUS_RULE',
  'NIGHTINGALE_POISON_PURGE_RULE',
  'NIGHTINGALE_STEEL_NURSING_RULE',
  'NIGHTINGALE_CRIMEAN_ANGEL_RULE',
  'NITOCRIS_BURIAL_RULE',
  'NITOCRIS_NECROMIRROR_RULE',
  'NITOCRIS_SACRED_RITE_RULE',
  'NOBUNAGA_HELLFIRE_RULE',
  'NOBUNAGA_THREE_LINE_RULE',
  'NURSERY_ROUND_RESET_RULE',
  'NURSERY_WOUND_SEED_RULE',
  'ODYSSEUS_TROJAN_HORSE_RULE',
  'ODYSSEUS_DIVINE_BODY_BARRIER_RULE',
  'OKITA_ALT_ENDLESS_DRAW_RULE',
  'OKITA_ALT_PURGATORY_RULE',
  'ORION_HUNTER_RULE',
  'ORION_FREE_LOVE_RULE',
  'ORION_LUCK_EXILE_POWER_RULE',
  'OSAKABE_CASTLE_MONSTER_RULE',
  'OSAKABE_CHIYOGAMI_RULE',
  'OSAKABE_HIMEJI_CASTLE_RULE',
  'OZYMANDIAS_TEMPLE_RULE',
  'OZYMANDIAS_DENDERA_RULE',
  'PARVATI_TWIN_ELIMINATION_RULE',
  'PARVATI_IMAGINARY_RING_RULE',
  'PASSIONLIP_MASOCHISTIC_RULE',
  'PASSIONLIP_DURGA_ARMOR_RULE',
  'PENTHESILEA_WAR_CRY_RULE',
  'PENTHESILEA_BEAUTY_SHAME_RULE',
  'PENTHESILEA_WRATH_RULE',
  'QUETZALCOATL_FLAME_CHAIN_RULE',
  'QUETZALCOATL_SUN_STONE_RULE',
  'QUETZALCOATL_WINGED_MOVE_RULE',
  'RAIKOU_EXTRA_ATTACK_RULE',
  'RAIKOU_SITUATION_IMMUNITY_RULE',
  'RAIKOU_MYSTERY_SLAYER_RULE',
  'ROMULUS_ROMAN_DISARM_RULE',
  'ROMULUS_ROMAN_VICTORY_RULE',
  'RYOUMA_SOARING_DRAGON_RULE',
  'RYOUMA_BLADE_RESTORATION_RULE',
  'RYOUMA_DRAGON_RESTORATION_RULE',
  'SABER_INVISIBLE_AIR_RULE',
  'SABER_EXCALIBUR_CLIMAX_RULE',
  'SAITOU_FLAG_SINCERITY_RULE',
  'SAITOU_FORMLESSNESS_RULE',
  'SALIERI_KYRIE_RULE',
  'SALIERI_WILDFIRE_RULE',
  'SALIERI_OBLIVION_CORRECTION_RULE',
  'SANSON_JUDGMENT_DAY_RULE',
  'SANSON_DEATH_HOPE_RULE',
  'SANSON_REGICIDE_RULE',
  'SANZANG_GOLDEN_CICADA_RULE',
  'SANZANG_TEACHINGS_RULE',
  'SANZANG_FIVE_ELEMENTS_PALM_RULE',
  'SASAKI_FIRST_STRIKE_RULE',
  'SASAKI_SECOND_STRIKE_RULE',
  'SASAKI_THIRD_STRIKE_RULE',
  'SCATHACH_WISDOM_RULE',
  'SCATHACH_PIERCING_SPEAR_RULE',
  'SCATHACH_SHADOW_LAND_GATE_RULE',
  'SEI_TWILIGHT_CLOUD_SPRING_TREE_RULE',
  'SEI_PLEIADES_RULE',
  'SEI_PILLOW_BOOK_RULE',
  'SEMIRAMIS_POISON_DRAGON_RULE',
  'SHAKESPEARE_ENCHANT_RULE',
  'SHAKESPEARE_TRAGEDY_RULE',
  'SHUTEN_DEBAUCHEROUS_BANQUET_RULE',
  'SHUTEN_NOXIOUS_SAKE_RULE',
  'SHUTEN_BONE_COLLECTOR_RULE',
  'SITONAI_COMBINATION_ATTACK_RULE',
  'SITONAI_POHJOLA_FIMBUL_RULE',
  'SKADI_WISDOM_RULE',
  'SKADI_RUNES_RULE',
  'SKADI_CASTLE_RULE',
]);
