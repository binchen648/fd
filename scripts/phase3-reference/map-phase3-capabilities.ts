...
const SPECIAL_EFFECTS = new Set([
  ...
  'KARNA_VASAVI_RULE',
  'KINGGIL_CANNON_RULE',
  'KINGGIL_TERRITORY_RULE',
  'KINGGIL_TREASURE_RULE',
  'KINGHASSAN_DEATH_BELL_RULE',
  'KINGHASSAN_SERVANT_KILL_RULE',
  'KINGPROTEA_GIANT_SHADOW_RULE',
  'KINGPROTEA_INFINITE_GROWTH_RULE',
  'KINGPROTEA_LOVE_SLEEP_RULE',
  'KINTOKI_GOLDEN_EATER_RULE',
  'KINTOKI_GOLDEN_SPARK_RULE',
  'JAGUARMAN_AMBUSH_FOREST_RULE',
  'JAGUARMAN_DEATH_CLAW_RULE',
  'JEANNE_RULER_COMMAND_SPELL_RULE',
  'JEANNE_LUCK_BANNER_RULE',
  'JEANNE_ALTER_ATTACK_COUNT_DEFEAT_RULE',
  'JEANNE_ALTER_AVENGER_MOVEMENT_RULE',
  'JEANNE_ALTER_LUCK_AVENGER_RULE',
  'JEKYLL_HYDE_ALTERNATION_RULE',
  'JEKYLL_HYDE_NOBLE_PHANTASM_RULE',
  'KAGEKIYO_HIDDEN_ATTACK_RULE',
  'KAGEKIYO_VENGEANCE_RULE',
]);
